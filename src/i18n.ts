...
const DICT: Record<string, Entry> = {
  ...
  "search.desc": {
    en: "Search our tattoo styles, FAQ, studio info and guest-artist details.",
    nl: "Doorzoek onze tattoostijlen, FAQ, studio-info en gastartiestgegevens.",
    de: "Durchsuche unsere Tattoo-Stile, FAQ, Studio-Infos und Gastkünstler-Details.",
    ua: "Шукай серед наших стилів тату, FAQ, інформації про студію та гостьових майстрів.",
  },
  "search.placeholder": {
    en: "Search typing (e.g., 'realism')...",
    nl: "Zoek door te typen (bijv. 'realisme')...",
    de: "Suche durch Eingabe (z. B. 'Realismus')...",
    ua: "Шукай, вводячи текст (напр. 'реалізм')...",
  },
